...
//#region node_modules/.nitro/vite/services/ssr/assets/dialog-C3QRezfV.js
...
function DialogContent({ className, children, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogPortal, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogOverlay, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent$1, {
		className: cn("fixed top-1/2 left-1/2 z-50 w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2", "rounded-xl bg-surface p-5 shadow-[var(--shadow-border)]", "focus:outline-none", className),
		...props,
		children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogClose, {
			className: "absolute top-3 right-3 flex size-11 items-center justify-center rounded-md text-muted transition-colors duration-150 hover:bg-raised hover:text-fg",
...
//#endregion
export { DialogHeader as a, Input as c, DialogDescription as i, Label as l, Dialog as n, DialogTitle as o, DialogContent as r, DialogTrigger as s, Button as t };
