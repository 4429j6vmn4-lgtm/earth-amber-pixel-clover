...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ns35mxOm.mjs");
...
var manifest = {
	"31ae685c0bb7c459f223fd7895ffd3f7dd6677beed9cf80f57b955bc207f0545": {
		functionName: "createProduct_createServerFn_handler",
		importer: () => import("./api-DwID38Ub.mjs")
	},
	"4dc9e68c67fad1c5721face4ff3122b6ae2a8f6acafe074e58b6c6bd3f2342a0": {
		functionName: "listAccounts_createServerFn_handler",
		importer: () => import("./api-DwID38Ub.mjs")
	},
	"4f183cc101c8fa2ad4ef5c671bd4c0f89a47907e4aabbaf318638584192ad23d": {
		functionName: "listEvents_createServerFn_handler",
		importer: () => import("./api-DwID38Ub.mjs")
	},
	"63e62798d256aad3bd79d8cff046450457bb798a7dbbacd5893c51a17295e595": {
		functionName: "createOrder_createServerFn_handler",
		importer: () => import("./api-DwID38Ub.mjs")
	},
	"b56fdfa903bfd15d08d9b450ef837e25126f3ad3a32ba17c610810e8bd51490d": {
		functionName: "listStockMoves_createServerFn_handler",
		importer: () => import("./api-DwID38Ub.mjs")
	},
	"b5a04bd4cdde78ef5f2018683f304f74b5481d2917f47686e97188dddda8a906": {
		functionName: "advanceOrder_createServerFn_handler",
		importer: () => import("./api-DwID38Ub.mjs")
	},
	"dcdb5e0f35f0b9d5551ac12a395f83eca45f13734974c6fe2bcd7bd2ce9920e2": {
		functionName: "listProducts_createServerFn_handler",
		importer: () => import("./api-DwID38Ub.mjs")
	},
	"e3f4e2a24cfb0190ed12c17a6a809feb55d7d67820acf3920b56321cdc2b7046": {
		functionName: "getDesk_createServerFn_handler",
		importer: () => import("./api-DwID38Ub.mjs")
	},
	"eebe64c1062596ae3c8be8859b2ff945ee1efeae9ed276f6b9ef7f7021064790": {
		functionName: "listOrders_createServerFn_handler",
		importer: () => import("./api-DwID38Ub.mjs")
	},
	"f41657e366e4e6a078706e8ebf7aa48ccbe2621877686890f5e31e52d274fb91": {
		functionName: "receiveStock_createServerFn_handler",
		importer: () => import("./api-DwID38Ub.mjs")
	},
	"f617390f4b0cbdae8a7b294842a1b2daf592cd1dacb6acdccc0ec841648cb246": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C9_KnaMU.mjs").then((n) => n.t),
